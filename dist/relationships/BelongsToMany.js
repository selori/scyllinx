 ...
 *
 */
class BelongsToMany extends Relationship_1.Relationship {
    /**
    ...
    async getResults() {
        ...
        if (connection === "default") {
            ...
            if (!relatedIds.length)
                return [];
            // Get related models
            const relatedQuery = new QueryBuilder_1.QueryBuilder(this.getRelatedTable(), connection)
    ...
    newPivotQuery() {
        ...
        return new QueryBuilder_1.QueryBuilder(this.pivotTable, related.getConnection()).allowFiltering();
    }
    /**
