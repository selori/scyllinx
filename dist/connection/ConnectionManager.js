...
const ScyllaDBDriver_1 = require("@/drivers/ScyllaDBDriver");
/**
...
class ConnectionManager {
    ...
    addConnection(name, config) {
        ...
        switch (config.driver) {
            case "scylladb":
                driver = new ScyllaDBDriver_1.ScyllaDBDriver(config);
                break;
            default:
                throw new Error(`Unsupported database driver: ${config.driver}`);
        }
        const connection = new Connection_1.Connection(name, driver, config);
