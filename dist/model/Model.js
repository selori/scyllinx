...
class Model {
    ...
    static query() {
        ...
        const builder = new QueryBuilder_1.QueryBuilder(instance.getTable(), instance.getConnection()).setModel(this);
   ...
   */
     ...
     */
    newQuery() {
        return new QueryBuilder_1.QueryBuilder(this.getTable(), this.getConnection()).setModel(this.constructor);
    }
    /**
    ...
    async load(...relations) {
        ...
        await new QueryBuilder_1.QueryBuilder(this.getTable(), this.getConnection())
    ...
    hasOne(related, foreignKey, localKey) {
        ...
        return new HasOne_1.HasOne(this, related, fk, lk);
    }
    /**
    ...
    hasMany(related, foreignKey, localKey) {
        const fk = foreignKey || `${this.getTable()}_id`;
        const lk = localKey || this.getKeyName();
        return new HasMany_1.HasMany(this, related, fk, lk);
    }
    /**
    ...
    belongsTo(related, foreignKey, ownerKey) {
        ...
        return new BelongsTo_1.BelongsTo(this, related, fk, ok);
    }
    /**
    ...
    belongsToMany(related, pivotTable, foreignPivotKey, relatedPivotKey, parentKey, relatedKey) {
        ...
        return new BelongsToMany_1.BelongsToMany(this, related, pivot, fpk, rk, pk, rpk);
    }
    /**
    ...
    morphOne(related, name, type, id, localKey) {
        ...
        const lk = localKey || this.getKeyName();
        return new MorphOne_1.MorphOne(this, related, morphType, morphId, lk);
    }
    /**
    ...
    morphMany(related, name, type, id, localKey) {
        ...
        const morphId = id || `${name}_id`;
        const lk = localKey || this.getKeyName();
        return new MorphMany_1.MorphMany(this, related, morphType, morphId, lk);
    }
    /**
    ...
    morphTo(name, type, id, ownerKey) {
        ...
        return new MorphTo_1.MorphTo(this, morphType, morphId, ok);
    }
}
exports.Model = Model;
