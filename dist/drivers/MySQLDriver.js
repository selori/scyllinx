...
const MySQLGrammar_1 = require("./grammars/MySQLGrammar");
/**
 ...
 */
class MySQLDriver extends DatabaseDriver_1.DatabaseDriver {
    /**
    ...
    constructor(config) {
        ...
        this.grammar = new MySQLGrammar_1.MySQLGrammar();
    }
    /**
     ...
     */
    async connect() {
        this.mysqlConnection = await promise_1.default.createConnection({
