...
exports.ScyllaDBDriver = void 0;
const cassandra_driver_1 = require("cassandra-driver");
const DatabaseDriver_1 = require("./DatabaseDriver");
const ScyllaDBGrammar_1 = require("./grammars/ScyllaDBGrammar");
/**
 ...
 *
 */
class ScyllaDBDriver extends DatabaseDriver_1.DatabaseDriver {
    /**
    ...
    constructor(config) {
        ...
        this.grammar = new ScyllaDBGrammar_1.ScyllaDBGrammar();
    }
    /**
    ...
    async connect() {
        ...
        this.client = new cassandra_driver_1.Client(clientOptions);
    ...
    mapValue(value) {
        ...
        if (value instanceof cassandra_driver_1.types.Uuid) {
            return value.toString();
        }
        if (value instanceof cassandra_driver_1.types.TimeUuid) {
            return value.toString();
        }
        if (value instanceof cassandra_driver_1.types.BigDecimal) {
            return value.toNumber();
        }
        if (value instanceof cassandra_driver_1.types.Long) {
            return value.toNumber();
        }
...
//# sourceMappingURL=ScyllaDBDriver.js.map