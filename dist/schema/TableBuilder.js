...
const ForeignKeyBuilder_1 = require("./ForeignKeyBuilder");
const ColumnBuilder_1 = require("./ColumnBuilder");
const TableOptionsBuilder_1 = require("./TableOptionsBuilder");
/**
...
class TableBuilder {
    ...
    string(name, length = 255) {
        ...
        return new ColumnBuilder_1.ColumnBuilder(col);
    }
    text(name) {
        const column = {
            name,
        ...
        return new ColumnBuilder_1.ColumnBuilder(column);
    }
    integer(name) {
        const column = {
            name,
     ...
     */
    foreign(column) {
        return new ForeignKeyBuilder_1.ForeignKeyBuilder(column, this.foreignKeys);
    }
    /**
    ...
    withOptions(callback) {
        const optsBuilder = new TableOptionsBuilder_1.TableOptionsBuilder();
