...
const MaterializedViewBuilder_1 = require("./MaterializedViewBuilder");
const UserDefinedTypeBuilder_1 = require("./UserDefinedTypeBuilder");
const UserDefinedFunctionBuilder_1 = require("./UserDefinedFunctionBuilder");
const UserDefinedAggregateBuilder_1 = require("./UserDefinedAggregateBuilder");
/**
...
class Schema {
    ...
    async createTable(table, callback) {
        const builder = new TableBuilder_1.TableBuilder(table);
        callback(builder);
    ...
    async createMaterializedView(viewName, baseTable, callback) {
        ...
        const builder = new MaterializedViewBuilder_1.MaterializedViewBuilder(viewName, baseTable);
        callback(builder);
    ...
    async createType(typeName, callback) {
        ...
        const builder = new UserDefinedTypeBuilder_1.UserDefinedTypeBuilder(typeName);
        callback(builder);
        const sql = builder.toSQL();
        await this.driver.query(sql);
    }
    ...
    async createFunction(functionName, callback) {
        ...
        const builder = new UserDefinedFunctionBuilder_1.UserDefinedFunctionBuilder(functionName);
        callback(builder);
        const sql = builder.toSQL();
        await this.driver.query(sql);
    }
    ...
    async createAggregate(aggregateName, callback) {
        ...
        const builder = new UserDefinedAggregateBuilder_1.UserDefinedAggregateBuilder(aggregateName);
        callback(builder);
        const sql = builder.toSQL();
        await this.driver.query(sql);
    }
    ...
    async dropAggregate(aggregateName, parameterTypes) {
        ...
        const builder = new UserDefinedAggregateBuilder_1.UserDefinedAggregateBuilder(aggregateName).withParameters(parameterTypes);
