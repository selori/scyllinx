...
export declare class ModelRegistry {
     ...
     *
     */
    register<TAttrs extends Record<string, any>>(name: string, modelClass: new (attributes?: Partial<TAttrs>) => Model<TAttrs>, aliases?: string[]): this;
    /**
     ...
     *
     */
    get<TAttrs extends Record<string, any>, TModel extends Model<TAttrs> = Model<TAttrs>>(name: string): new (attributes?: Partial<TAttrs>) => TModel;
    /**
     ...
     *
     */
    autoDiscover(directory?: string): void;
    /**
